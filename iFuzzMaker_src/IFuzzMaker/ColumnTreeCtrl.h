...
//	CHeaderCtrl& GetHeaderCtrl() { return m_Header; }
	CMFCHeaderCtrl& GetHeaderCtrl() { return m_Header; }
//	IPA Mod <-
...
//	CHeaderCtrl m_Header2;
	CMFCHeaderCtrl m_Header;
	CMFCHeaderCtrl m_Header2;
//	IPA Mod <-
...
//	IPA Add ->
	virtual COLORREF OnGetCellBkColor( HTREEITEM hItem, int nColumn );
